        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                ...
                                .requestMatchers("/api/v1/tasks/**").hasAnyAuthority("ADMIN", "MANAGER")
...
//                                .requestMatchers("/api/v1/projects/list/{completed}").permitAll()
...
//                                .requestMatchers("/api/v1/users/update/{id}").hasAuthority("ADMIN")
